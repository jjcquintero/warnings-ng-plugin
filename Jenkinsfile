pipeline {
    ...
    stages {
        ...
        stage("Dependency Check") {
            steps {
                dependencyCheckAnalyzer datadir: 'target/dependency-check-report.xml', hintsFile: '', includeCsvReports: false, includeHtmlReports: false, includeJsonReports: false, includeVulnReports: false, isAutoupdateDisabled: false, outdir: 'target', scanpath: 'src', skipOnScmChange: false, skipOnUpstreamChange: false, suppressionFile: '', zipExtensions: ''
            }
        }
    }
